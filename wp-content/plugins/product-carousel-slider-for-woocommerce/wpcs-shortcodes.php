		        	...
		        	<div class="product_container">
			            ...
			            <div class="caption">
			            	...
			            	if ($wpcs_display_product_title == 'yes') { ?>			               
				              <h3 class="product_name"><a id="id-<?php the_id(); ?>" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a></h3>
				            <?php } 
				            ?>
				            <div><?php echo substr( strip_tags( get_the_content() ) ,0,40);?></div>
				            <div class="product-slider-category">

				            	<?php 
				            	$prod_cat = get_the_terms(get_the_id(), "product_cat" );
